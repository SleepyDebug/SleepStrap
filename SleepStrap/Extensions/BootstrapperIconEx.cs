    ...
    static class BootstrapperIconEx
    {
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconSleepStrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconSleepStrap => Properties.Resources.IconSleepStrap,
                // Keep upgraded installs on the SleepStrap artwork when an older
                // settings file references a legacy icon enum value.
                BootstrapperIcon.LegacySleepStrap => Properties.Resources.IconSleepStrap,
                ...
                BootstrapperIcon.LegacySleepStrapClassic => Properties.Resources.IconSleepStrap,
                _ => Properties.Resources.IconSleepStrap
            };
        }
    }
}
