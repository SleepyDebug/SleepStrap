...
using SleepStrap.Models.APIs;
using SleepStrap.Models.APIs.RoValra;
using CommunityToolkit.Mvvm.Input;

namespace SleepStrap.Models.Entities
{
    public class ActivityData
    {
        ...
        // Everything below is optional and used by SleepStrapRPC, Discord rich presence, or game history.
