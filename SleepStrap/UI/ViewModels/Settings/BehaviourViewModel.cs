...
namespace SleepStrap.UI.ViewModels.Settings
{
    public class BehaviourViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public bool CleanerSleepStrap
        {
            get => CleanerItems.Contains("SleepStrapLogs");
            set
            {
                if (value)
                    CleanerItems.Add("SleepStrapLogs");
                else
                    CleanerItems.Remove("SleepStrapLogs");
            }
        }
