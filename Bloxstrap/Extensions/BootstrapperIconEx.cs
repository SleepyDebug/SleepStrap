    ...
    static class BootstrapperIconEx
    {
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            return icon switch
            {
                ...
                // settings file still references the original Bloxstrap icon.
                BootstrapperIcon.IconBloxstrap => Properties.Resources.IconSleepStrap,
                ...
                BootstrapperIcon.IconBloxstrapClassic => Properties.Resources.IconSleepStrap,
